...
/**
 * @file dtkGraphicsTools.h
 * @brief  dtkGraphicsTools 头文件
...
extern void CalcBoundingBox(dtkFloat3 &boxMin, dtkFloat3 &boxMax,
                            dtkPoints::Ptr points);

// calculte the circumsphere of a tetrahedron, return the center and radius's
...
// calculte the circumsphere of a tetrahedron, return the center and radius's
// square of the sphere.
inline void CalcCircumSphere2(dtkFloat3 &center, float &radius2,
                              dtkFloat3 pts[4], float tolerance) {
  CalcCircumSphere2(center, radius2, pts[0], pts[1], pts[2], pts[3], tolerance);
}

// Calculate the area of a triangle.
extern float Area(const dtkFloat3 &ptA, const dtkFloat3 &ptB,
                  const dtkFloat3 &ptC);

// Test whether a sphere is intersect with a AABB Bounding-Box
extern bool Intersect_SphereAABB(const dtkFloat3 &sphereCenter,
                                 const float &radius2, const dtkFloat3 &boxMin,
                                 const dtkFloat3 &boxMax);
...
extern int Inclusion_TetraPoint(const dtkFloat3 &pt, const dtkFloat3 &pa,
