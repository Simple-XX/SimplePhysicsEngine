...
/**
 * @file dtkIntersectTest.h
 * @brief  dtkIntersectTest 头文件
...
public:
  ...
  // 3D
  // --CGAL Wrapper
  static bool Test(GK::Point3 &pt, const GK::Line3 &line,
                   const GK::Plane3 &plane);
  static bool Test(GK::Point3 &pt, const GK::Ray3 &ray,
                   const GK::Plane3 &plane);
  static bool Test(GK::Point3 &pt, const GK::Segment3 &seg,
                   const GK::Plane3 &plane);
  ...
  static bool DoIntersect(const GK::Triangle3 &triangle_1,
                          const GK::Triangle3 &triangle_2);
  static bool DoIntersect(const GK::Triangle3 &triangle,
                          const GK::Segment3 &segment);

  // --DTK Implement
  static bool DoIntersect(const GK::Tetrahedron3 &tetra,
  ...
  static bool DoDistanceIntersect(const GK::Segment3 &seg_1,
                                  const GK::Segment3 &seg_2, double distance,
                                  IntersectResult::Ptr &result);
  static bool DoDistanceIntersect(const GK::Triangle3 &tri,
                                  const GK::Segment3 &seg, double distance,
                                  IntersectResult::Ptr &result,
                                  dtkID invert = 0);
  static bool DoDistanceIntersect(const GK::Triangle3 &tri_1,
                                  const GK::Triangle3 &tri_2, double distance,
                                  IntersectResult::Ptr &result,
                                  dtkID invert = 0);
  static bool DoDistanceIntersect(const GK::Triangle3 &tri,
                                  const GK::Sphere3 &sphere, double distance,
                                  IntersectResult::Ptr &result);
...
private:
  static void UpdateMinMax(GK::Float &tmin, GK::Float &tmax,
                           const GK::Float &val);

  static void ProjectToAxis(GK::Float &amin, GK::Float &amax,
                            const GK::Triangle2 &triangle,
                            const GK::Vector2 &axis);

  static void ProjectToAxis(GK::Float &amin, GK::Float &amax,
                            const GK::Circle2 &circle, const GK::Vector2 &axis);
  ...
  static void ProjectToAxis(GK::Float &amin, GK::Float &amax,
                            const GK::Sphere3 &sphere, const GK::Vector3 &axis);

  static bool IsOverlap(GK::Float min0, GK::Float max0, GK::Float min1,
                        GK::Float max1);
