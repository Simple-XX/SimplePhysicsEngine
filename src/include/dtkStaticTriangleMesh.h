...
/**
 * @file dtkStaticTriangleMesh.h
 * @brief  dtkStaticTriangleMesh 头文件
...
namespace dtk {
  ...
  public:
    ...
    bool IsValidVertex(dtkID& vertexID) const {
      if (vertexID < 0 || vertexID > mV2E.size())
        return false;
  ...
  public:
    ...
    static dtkID EncodeHE(dtkID tri, dtkID idx) { return (tri << 2) | idx; }
    ...
    static dtkID2 GetHEVertex(const dtkID& he, const std::vector<dtkID3>& ec,
                              const std::vector<dtkID>& b2e) {
      dtkID2 retVal;
      dtkID c, i;
...
#endif /* SIMPLEPHYSICSENGINE_DTKSTATICTRIANGLEMESH_H */
