...
namespace dtk {
template <class T> inline dtkMatrix<T> transform_identity_matrix() {
  dtkMatrix<T> m(4, 4, 0);
  m(0, 0) = 1;
  m(1, 1) = 1;
  m(2, 2) = 1;
...
template <class T> inline dtkMatrix<T> rotate_x_matrix(T angle) {
  dtkMatrix<T> m(4, 4, 0);
  m(0, 0) = 1;
  m(1, 1) = cos(angle);
  m(1, 2) = -sin(angle);
...
template <class T> inline dtkMatrix<T> rotate_y_matrix(T angle) {
  dtkMatrix<T> m(4, 4, 0);
  m(0, 0) = cos(angle);
  m(0, 2) = sin(angle);
  m(1, 1) = 1;
...
template <class T> inline dtkMatrix<T> rotate_z_matrix(T angle) {
  dtkMatrix<T> m(4, 4, 0);
  m(0, 0) = cos(angle);
  m(0, 1) = -sin(angle);
  m(1, 0) = sin(angle);
...
template <class T> inline dtkMatrix<T> translate_matrix(T x, T y, T z) {
  dtkMatrix<T> m(4, 4, 0);
  m(0, 0) = 1;
  m(1, 1) = 1;
  m(2, 2) = 1;
...
template <class T> inline dtkMatrix<T> scale_matrix(T x, T y, T z) {
  dtkMatrix<T> m(4, 4, 0);
  m(0, 0) = x;
  m(1, 1) = y;
  m(2, 2) = z;
...
template <class T> inline dtkMatrix<T> align_z_matrix(dtkT3<T> &uz) {
...
template <class T>
inline dtkMatrix<T> operator*(const dtkMatrix<T> &lhs,
                              const dtkMatrix<T> &rhs) {
...
template <class T> inline dtkMatrix<T> transpose(const dtkMatrix<T> &im) {
