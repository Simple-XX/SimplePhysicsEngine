...
namespace dtk {
//------------------------------------------------------
template <class T> struct dtkT2 {
  T x, y;

  dtkT2(const T &px = 0, const T &py = 0) : x(px), y(py) {}

  dtkT2(const dtkT2<T> &rhs) : x(rhs.x), y(rhs.y) {}
  ...
  T &operator[](const int &n) {
    return const_cast<T &>(static_cast<const dtkT2<T> &>(*this)[n]);
  }
};
...
//------------------------------------------------------
template <class T> struct dtkT3 {
  T x, y, z;

  dtkT3(const T &px = 0, const T &py = 0, const T &pz = 0)
      : x(px), y(py), z(pz) {}

  dtkT3(const dtkT3<T> &rhs) : x(rhs.x), y(rhs.y), z(rhs.z) {}
  ...
  T &operator[](const int &n) {
    return const_cast<T &>(static_cast<const dtkT3<T> &>(*this)[n]);
  }
};
...
//------------------------------------------------------
template <class T> struct dtkT4 {
  T x, y, z, w;

  dtkT4(const T &px = 0, const T &py = 0, const T &pz = 0, const T &pw = 0)
      : x(px), y(py), z(pz), w(pw) {}

  dtkT4(const dtkT4<T> &rhs) : x(rhs.x), y(rhs.y), z(rhs.z), w(rhs.w) {}
  ...
  T &operator[](const int &n) {
    return const_cast<T &>(static_cast<const dtkT4<T> &>(*this)[n]);
  }
};
