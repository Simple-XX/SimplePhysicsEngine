...
struct dtkID2 {
  ...
  dtkID2(const dtkID &x = 0, const dtkID &y = 0) : a(x), b(y) {}

  dtkID2(const dtkID2 &rhs) : a(rhs.a), b(rhs.b) {}
  ...
  dtkID &operator[](const int &n) {
    return const_cast<dtkID &>(static_cast<const dtkID2 &>(*this)[n]);
  }
...
inline dtkID2 sort(const dtkID2 &id) { return sort(id.a, id.b); }
...
struct dtkID3 {
  ...
  dtkID3(const dtkID3 &rhs) : a(rhs.a), b(rhs.b), c(rhs.c) {}
  ...
  dtkID &operator[](const int &n) {
    return const_cast<dtkID &>(static_cast<const dtkID3 &>(*this)[n]);
  }
...
inline dtkID3 sort(const dtkID &id0, const dtkID &id1, const dtkID &id2) {
  ...
  if (rtn.a > rtn.b)
    std::swap(rtn.a, rtn.b);
  if (rtn.a > rtn.c)
    std::swap(rtn.a, rtn.c);
  if (rtn.b > rtn.c)
    std::swap(rtn.b, rtn.c);

  return rtn;
}

inline dtkID3 sort(const dtkID3 &id) { return sort(id.a, id.b, id.c); }
...
struct dtkID4 {
  ...
  dtkID4(const dtkID &ta = 0, const dtkID &tb = 0, const dtkID &tc = 0,
         const dtkID &td = 0)
      : a(ta), b(tb), c(tc), d(td) {}

  dtkID4(const dtkID4 &rhs) : a(rhs.a), b(rhs.b), c(rhs.c), d(rhs.d) {}
  ...
  dtkID &operator[](const int &n) {
    return const_cast<dtkID &>(static_cast<const dtkID4 &>(*this)[n]);
  }
...
inline dtkID4 sort(const dtkID &a, const dtkID &b, const dtkID &c,
                   const dtkID &d) {
  dtkID4 rtn(a, b, c, d);
  ...
  if (rtn.a > rtn.c)
    std::swap(rtn.a, rtn.c);
  if (rtn.a > rtn.d)
    std::swap(rtn.a, rtn.d);
  if (rtn.b > rtn.c)
    std::swap(rtn.b, rtn.c);
  if (rtn.b > rtn.d)
    std::swap(rtn.b, rtn.d);
  if (rtn.c > rtn.d)
    std::swap(rtn.d, rtn.c);

  return rtn;
}

inline dtkID4 sort(const dtkID4 &id) { return sort(id.a, id.b, id.c, id.d); }
