...
/**
 * @file dtkMatrixAlgorithm.h
 * @brief  dtkMatrixAlgorithm 头文件
...
extern double Det4x4(double a11, double a12, double a13, double a14, double a21,
...
extern double Det4x4(float a11, float a12, float a13, float a14, float a21,
...
extern double Det3x3(double a11, double a12, double a13, double a21, double a22,
                     double a23, double a31, double a32, double a33);

extern double Det3x3(float *A);

extern double Det3x3(float a11, float a12, float a13, float a21, float a22,
...
extern bool cholesky_pack2(double *A,
                           const size_t &n); // D replace A's diagonal
...
extern bool solution_chol3(const size_t &n, double *A, const size_t &nb,
                           double *b, double *x);
...
// Return��bool
//////////////////////////////////////////////////////////////////////
bool JacobiEigenv2(const size_t &n, double *A, double *dblEigenValue,
                   double *mtxEigenVector, double eps = 0.000001);
