...
/**
 * @file dtkCollisionPair.h
 * @brief dtkCollisionPair 头文件
...
public:
  ...
  dtkCollisionPair(dtk::dtkRigidBody::ptr a, dtk::dtkRigidBody::ptr b,
  ...
  static void do_collision_mr(dtkMesh::ptr &pa,
